...
We validate GAHIB through 11 complementary experimental studies
organised into three groups.
7 \emph{comparative benchmarks} quantify GAHIB's performance relative to
prior art:
...
captures aspects of developmental hierarchy, gene programs,
cell-type homophily, and tissue-specific Gene Ontology Biological
Process enrichment (\cref{sec:go}) on a representative subset of
datasets for which cell-type or lineage annotations are available.
