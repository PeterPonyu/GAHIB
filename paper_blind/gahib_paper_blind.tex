...
% Empty pdfauthor/pdftitle prevents any leakage of OS username or
% draft title into the PDF metadata for double-anonymous review.
\hypersetup{
  colorlinks=true,
...
% ─────────────────────────────────────────────────────────────────────────
% Author names, affiliations, emails, and ORCIDs have been removed for
% double-anonymous peer review. Author information will be supplied via
% the journal submission system (Snapp).
% ─────────────────────────────────────────────────────────────────────────
\author{Anonymous Author(s)}
\address{Affiliations withheld for double-anonymous review.}
...
\paragraph{Code.}
The core library (model, metrics, interpretation utilities), the 11
experiment runners, and the test suite will be released under an
open-source licence upon acceptance. The repository URL is
\emph{withheld for double-anonymous review} and will be disclosed
in the camera-ready version. An anonymised archive can be provided
...
% ─────────────────────────────────────────────────────────────────────────
% Author contributions, funding, and competing-interest statements have
% been removed for double-anonymous peer review (per journal policy).
% These will be supplied via the submission system and added to the
...
AI-based coding-assistance tools (large language models) were used
during \emph{code development} only---specifically for boilerplate
scaffolding, routine debugging, and visualisation helper generation
in the GAHIB implementation and experiment pipelines.
...
interpretations, manuscript text, and conclusions are original work
and full responsibility is taken for all content.
