...
generators will be released under an open-source licence upon
acceptance.
The repository URL is \emph{withheld for double-anonymous review} and
will be disclosed in the camera-ready version.
The repository includes the 11 experiment runners, the visualisation
pipeline, and reproducibility instructions; an anonymised archive can
be provided to the editors on request.
